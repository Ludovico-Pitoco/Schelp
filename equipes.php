...
<a href="criarequipe.php">
    <button class="botao-criar">
        <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="#FFFFFF" stroke="#FFFFFF">
            <line x1="12" y1="19" x2="12" y2="5" stroke="#FFFFFF" stroke-width="2"/>
...
<?php
$sql = "SELECT * FROM equipes_com_usuario WHERE codconta = ? ORDER BY nome_equipe";
...
while ($dados = $result->fetch_assoc()) {
    echo "
    <a href='equipe.php?codequipe=" . $dados['codequipe'] . "'>
